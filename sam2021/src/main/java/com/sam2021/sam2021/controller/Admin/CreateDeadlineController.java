...
public class CreateDeadlineController {
    ...
    public String creatDeadline(@ModelAttribute("title") String name, @ModelAttribute("Description") String description, @ModelAttribute("Deadlines") Deadlines deadlines,@ModelAttribute("chair") User chairman ,@ModelAttribute("reviewtemp") ReviewTemplate reviewTemplate,  BindingResult result) {
        // if(result.hasErrors()){
